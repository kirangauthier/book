...
we should reserved the right to be informed of any mixing issue so we will be
...
This diagnostic tool returns the trace plot for us to discern any issue with
...
We recommend that users proceed to truthfully present the findings from
the posterior summary but not to stick to the point estimates.
...
The point estimates are way off, and the credible intervals are too wide
to be informative. To avoid this, it is important to have a devised RED
with a nudge attractive enough to induce a high proportion of compliers.

#### Visualization of Knowledge Progression

The visualization tool discloses that the two modes are separated by zero,
